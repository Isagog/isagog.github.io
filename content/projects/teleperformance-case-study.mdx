...
Isagog’s reasoner for the Voice First project follows a neuro-symbolic approach and is built on three main components: Neural Parser – processes fragments of conversation, identifying and classifying key elements; Abductive Reasoner – interprets these elements by relating them to the customer’s context; Knowledge Base – holds business models and customer-specific information used for reasoning and decision-making.