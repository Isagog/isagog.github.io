  ...
  "home-page": {
    ...
    highlight: {
      ...
      "1": {
        ...
        description:
          "(Reti neurali) – Ispirate al funzionamento del cervello, apprendono dai dati sulla base delle loro correlazioni, senza esplicitare i propri criteri decisionali.",
      },
      "2": {
        title: "2. Ragionamento",
        description:
          "(AI simbolica) – Utilizza logica formale, regole e conoscenza esplicita (ontologia) per simulare processi di ragionamento razionale.",
      },
      "3": {
      ...
      "4": {
        title: "Trasparenza",
        description:
          "Le decisioni dell’AI sono spiegabili e verificabili, grazie alla presenza di strutture logiche accessibili.",
      },
      "5": {
        title: "Inferenze logiche",
        description:
          "Il sistema non si limita a riconoscere schemi, ma applica la logica per affrontare situazioni nuove in modo coerente.",
      },
      "6": {
        title: "Affidabilità",
        description:
          "Riduce gli errori e le cosiddette “allucinazioni” tipiche delle reti neurali, offrendo risposte più stabili e corrette.",
      },
      "7": {
        title: "Adattabilità",
        description:
