export default {
  ...
  "home-page": {
    ...
    "text-section": {
      "1": {
        firstParagraph:
          "Extract information and patterns of meaning from your documents",
      ...
      "2": {
        ...
        thirdParagraph:
          "Detect tone, semantic nuances, and whatever hides between the lines ",
      },
      "3": {
        firstParagraph:
          "Develop AI agents that assist you through natural language interactions",
        secondParagraph:
          "Generate assessments, briefs, knowledge maps, and more—on demand",
        thirdParagraph:
  ...
  "work-with-us-page": {
    label:
      "If you want to find out about our career opportunities, please write to hiring@isagog.com",
  },
  "service-page": {
    "image-with-description": {
      "1": {
        ...
        firstParagraph:
          "Turn your data into a living archive—accessible, intelligent, and actionable",
        secondParagraph:
          "Gain a dynamic map of your data and industry knowledge",
        thirdParagraph:
          "Discover new meanings and connections across large volumes of data",
      },
      "2": {
        title: "Produce content",
        firstParagraph:
          "Automate summaries and reports on demand, aligned with your company’s standards",
        secondParagraph:
          "Develop new narratives and reinvent how your company communicates its value",
      },
      "3": {
      ...
      "4": {
        ...
        secondParagraph:
          "Engage users with rich industry knowledge and smooth AI interactions.",
    ...
    "why-us": {
      title: "Why Isagog?",
      description:
        "Our solutions are built on an open neuro-symbolic AI platform that blends creativity and logic to achieve more intelligent and reliable results.",
    ...
    "text-carousel": {
      "1": {
        title: "What",
        subtitle:
          "We simplify access to information.We transform text archives into clear, instantly accessible intelligence.",
        points: {
